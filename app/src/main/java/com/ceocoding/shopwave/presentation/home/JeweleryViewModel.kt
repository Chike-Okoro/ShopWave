...
import com.ceocoding.shopwave.domain.use_case.product.GetJeweleryProductsUseCase
...
class JeweleryViewModel @Inject constructor(
    private val getJeweleryProductsUseCase: GetJeweleryProductsUseCase
): ViewModel() {
    ...
    private fun getProducts() {
        viewModelScope.launch {
            getJeweleryProductsUseCase().onEach { result ->
                when(result){
                    is Resource.Loading -> {
